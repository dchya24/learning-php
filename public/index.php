...
define('CURRENT_URL', $_SERVER['QUERY_STRING']);
/**
 * Error Reporting
 */
...
$route->add('settings', ['controller' => 'HomeController', 'action' => 'settings']);
...
$route->add('api/post/update-user', ['controller' => "HomeController", "action" => "postUpdateUser"]);
